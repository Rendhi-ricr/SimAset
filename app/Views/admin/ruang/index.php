        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="text-end">
                    ...
                    <a href="ruang/tambah" class="btn btn-primary"><i class="ti ti-plus ti-sm"></i> Tambah</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <thead>
                                ...
                                foreach ($ruang as $key => $value) : ?>
                                    <tr>
                                        <td> </td>
                                        <td><?= $no++; ?></td>
                                        <td><?= $valeu->nama_gedung; ?></td>
                                        <td><?= $valeu->lantai; ?></td>
                                        <td><?= $valeu->nama_ruangan; ?></td>
                                        <td><?= $valeu->kode_ruangan; ?></td>
                                        <td><?= $valeu->keterangan; ?></td>
                                        <td></td>
